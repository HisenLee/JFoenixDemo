...
@ViewController(value = "/fxml/SVGLoader.fxml")
public final class SVGLoaderController {
    ...
    private static final class GlyphDetailViewer extends VBox {
        ...
        GlyphDetailViewer() {
            ...
            sizeSlider.setIndicatorPosition(JFXSlider.IndicatorPosition.RIGHT);
