...
@ViewController(value = "/fxml/ScrollPane.fxml")
public final class ScrollPaneController {

    @FXML
    private JFXListView<String> contentListView;
    @FXML
    ...
    public void init() {
        ...
        for (int i = 0; i < 100; i++) {
            contentListView.getItems().add("Item " + i);
        }
        contentListView.setMaxHeight(3400);
